...
import { 
  Github, Linkedin, Mail, FileText, FolderOpen, 
  ChevronRight, Eye, Bot, Database, ExternalLink,
  Settings2, GraduationCap, Award, CheckCircle2, 
  Briefcase, Cpu, Sun, Moon, Palette, X, Image as ImageIcon
} from 'lucide-react';
...
const museumGlob = import.meta.glob('./assets/nu-*.jpg', { eager: true, import: 'default' });
const museumImages = Object.values(museumGlob); 
const [nu1, nu2, nu3, nu4, nu5, nu6, nu7, nu8] = museumImages;

const cbGlob = import.meta.glob('./assets/cb-*.jpg', { eager: true, import: 'default' });
const cbImages = Object.values(cbGlob); 
const [cb1, cb2] = cbImages;

const lfGlob = import.meta.glob('./assets/lf-*.jpg', { eager: true, import: 'default' });
...
const designProjects = [
  ...
  },
  {
    ...
    images: ["https://images.unsplash.com/photo-1626785774573-4b799312c95d?auto=format&fit=crop&q=80&w=800"]
  }
];
...
const skills = {
  languages: ["Python", "C / C++", "JavaScript", "TypeScript", "Java", "SQL", "PHP"],
  frameworks: ["React", "Node.js", "Flutter", "Tailwind CSS", "OpenCV", "Arduino", "MPLAB X", "Cisco Packet Tracker", "Android Studio", "EagleCAD", "Git", "XAMPP"],
  specialized: ["Computer Vision", "Embedded Architecture", "PCB Design", "Deep Learning", "Digital Marketing", "Video Editing"]
};

// --- Sub-Components ---

const SkillBadge = ({ text }) => (
  <span className="px-3 py-1.5 rounded-md text-xs font-medium border cursor-default transition-all duration-200 
          ...
          {project.images && project.images.length > 0 ? (
            <div className="grid gap-6">
              {project.images.map((img, idx) => (
                <div key={idx} className="rounded-xl overflow-hidden border border-gray-100 dark:border-white/5 shadow-sm">
...
const Portfolio = () => {
  ...
  return (
    <div className={`min-h-screen antialiased selection:bg-blue-500/20 selection:text-blue-500 overflow-x-hidden relative transition-colors duration-300
      bg-gray-50 text-gray-600
      dark:bg-[#050505] dark:text-[#86868b]`}>
      
      <ProjectModal project={selectedProject} onClose={() => setSelectedProject(null)} />

      <nav className="fixed top-0 w-full z-40 transition-all duration-300 backdrop-blur-xl border-b 
        bg-white/70 border-gray-200
        dark:bg-[#050505]/70 dark:border-white/[0.08]">
        <div className="max-w-5xl mx-auto px-6 h-14 flex items-center justify-between">
          <a href="#" className="font-semibold tracking-tight text-sm flex items-center gap-2 transition-colors
          ...
          <div className="flex items-center gap-4 text-xs font-medium">
            <a href="https://github.com/joaquindumas" target="_blank" rel="noopener noreferrer" className="hidden sm:flex items-center gap-1.5 transition-colors
              text-gray-500 hover:text-black
              dark:text-[#86868b] dark:hover:text-white">
              <Github className="w-3.5 h-3.5" />
              Github
            </a>
            <a href="https://linkedin.com/in/imjoaquindumas" target="_blank" rel="noopener noreferrer" className="hidden sm:flex items-center gap-1.5 transition-colors
              text-gray-500 hover:text-black
              dark:text-[#86868b] dark:hover:text-white">
            ...
            <a href="mailto:imjoaquindumas@gmail.com" className="px-3 py-1.5 rounded-md font-semibold transition-all flex items-center gap-2 hover:scale-105 active:scale-95
      ...
      <main className="max-w-5xl mx-auto pt-40 px-6 pb-24">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center fade-in-init">
            <div className="order-2 md:order-1 flex flex-col items-start text-left">
              ...
              <p className="text-justify leading-relaxed mb-8 max-w-lg text-gray-500 dark:text-[#a1a1a6]">
                A Computer Engineer and designer crafting experiences where logic meets aesthetics. From complex coding to visual storytelling, I engineer systems that are as beautiful as they are functional.
              </p>
              <div className="flex flex-wrap items-center gap-3">
                <a href="#skills" className="group flex items-center gap-2 px-4 py-2 rounded-lg border transition-all text-sm font-medium
                  ...
                  <span className="text-blue-500 dark:text-blue-400 group-hover:text-blue-600 dark:group-hover:text-blue-300 transition-colors">&lt;/&gt;</span>
                  Skills
                </a>
                <a href="#projects" className="group flex items-center gap-2 px-4 py-2 rounded-lg border transition-all text-sm font-medium
                  border-gray-300 text-gray-600 hover:text-black hover:bg-gray-100 hover:border-gray-400
                  dark:border-[#2c2c2e] dark:text-[#a1a1a6] dark:hover:text-[#f5f5f7] dark:hover:border-[#525255] dark:hover:bg-white/5">
            ...
            <div className="order-1 md:order-2 flex justify-center md:justify-end">
              <div className="relative group cursor-pointer">
                ...
                <div className="relative h-64 w-64 md:h-80 md:w-80 rounded-full overflow-hidden border-2 bg-[#1c1c1e]
        ...
        {/* Selected Projects */}
        <section id="projects" className="py-12 border-t reveal
          border-gray-200 dark:border-[#1d1d1f]">
          <div className="flex flex-col sm:flex-row justify-between items-end mb-10 gap-4">
            <div>
              <h2 className="font-semibold text-2xl tracking-tight
                text-gray-900 dark:text-[#f5f5f7]">Engineering Projects</h2>
              <p className="text-sm mt-1 text-gray-500 dark:text-[#86868b]">Hardware firmware, computer vision, and web systems.</p>
            </div>
            <a href="https://github.com/joaquindumas" target="_blank" rel="noopener noreferrer" className="text-xs font-medium text-blue-500 dark:text-blue-400 hover:text-blue-600 dark:hover:text-blue-300 transition-colors flex items-center gap-1 group">
              View full archive 
              ...
              >
                <div>
                  <div className="flex justify-between items-start mb-6">
                    ...
                    <span className="text-[10px] font-mono border px-2 py-0.5 rounded-md
                      ...
                      dark:text-[#6e6e73] dark:border-[#2c2c2e]">{project.year}</span>
                  </div>
                  <h3 className="font-semibold text-lg mb-2
                    text-gray-900 dark:text-[#f5f5f7]">{project.title}</h3>
                ...
                <div>
                  <div className="h-px w-full mb-4 transition-colors
                    ...
                    dark:bg-white/5 dark:group-hover:bg-white/10"></div>
                  <div className="flex flex-wrap gap-x-2 gap-y-2">
                    {project.tags.map((tag, i) => (
                      <span key={i} className="text-[11px] px-2 py-1 rounded
                        bg-gray-100 text-gray-600
                        dark:bg-white/5 dark:text-[#d1d1d6]">{tag}</span>
                    ))}
                  </div>
        ...
        <section id="design" className="py-12 border-t reveal border-gray-200 dark:border-[#1d1d1f]">
          <div className="mb-10">
            <h2 className="font-semibold text-2xl tracking-tight text-gray-900 dark:text-[#f5f5f7]">Creative Works</h2>
            <p className="text-sm mt-1 text-gray-500 dark:text-[#86868b]">Graphic design, branding, and visual layouts.</p>
          </div>

          <div className={designProjects.length === 1 ? "max-w-2xl mx-auto" : "grid md:grid-cols-2 gap-6"}>
                ...
                <div className="p-6">
                   <div className="flex justify-between items-start mb-4">
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-xs font-semibold text-purple-500">{project.role}</span>
                        </div>
                        <span className="text-[10px] font-mono border px-2 py-0.5 rounded-md text-gray-500 border-gray-200 dark:text-[#6e6e73] dark:border-[#2c2c2e]">{project.year}</span>
                    </div>

                    <h3 className="font-semibold text-lg mb-2 text-gray-900 dark:text-[#f5f5f7]">{project.title}</h3>
                    ...
                    <div className="flex flex-wrap gap-2">
                        {project.tags.map((tag, i) => (
                        <span key={i} className="text-[10px] px-2 py-1 rounded bg-gray-100 text-gray-600 dark:bg-white/5 dark:text-[#d1d1d6]">{tag}</span>
                        ))}
                    </div>
                </div>
             </div>
        ...
        <section id="experience" className="py-12 border-t reveal
           border-gray-200 dark:border-[#1d1d1f]">
          <div className="grid md:grid-cols-2 gap-16">
            
            {/* Left Column: Education & Certs */}
            <div>
              <h2 className="font-semibold text-lg mb-8 flex items-center gap-2
              ...
              <div className="space-y-8">
                <div className="relative pl-6 border-l border-gray-300 dark:border-[#2c2c2e]">
                  ...
                  <h3 className="font-medium text-base text-gray-900 dark:text-[#f5f5f7]">De La Salle University - Dasmariñas</h3>
                  <p className="text-xs text-gray-500 dark:text-[#86868b] mt-1 mb-2">Aug 2021 — Aug 2026</p>
                  <p className="text-sm text-gray-600 dark:text-[#a1a1a6]">BS in Computer Engineering</p>
                </div>
                <div className="relative pl-6 border-l border-gray-300 dark:border-[#2c2c2e]">
                  ...
                  <h3 className="font-medium text-base text-gray-900 dark:text-[#f5f5f7]">Lyceum of the Philippines - Cavite</h3>
                  <p className="text-xs text-gray-500 dark:text-[#86868b] mt-1 mb-2">Jun 2018 — Jun 2020</p>
                  <p className="text-sm text-gray-600 dark:text-[#a1a1a6]">TVL - ICT Track</p>
                </div>
              </div>

              <h2 className="font-semibold text-lg mt-12 mb-8 flex items-center gap-2
                 text-gray-900 dark:text-[#f5f5f7]">
                  ...
                  <li key={index} className="flex items-start gap-3 text-sm group">
                    ...
                    <div>
                      <span className="block transition-colors
                        ...
                        dark:text-[#f5f5f7] dark:group-hover:text-white">{cert}</span>
                      <span className="text-xs
                        text-gray-500
                        dark:text-[#6e6e73]">DLSU-D CpE Dept • 2025</span>
                    </div>
                  </li>
                ))}
              </ul>
            ...
            <div>
              ...
              <div className="relative pl-6 border-l border-gray-300 dark:border-[#2c2c2e]">
                <div className="absolute -left-[5px] top-1.5 h-2.5 w-2.5 rounded-full border-2 border-white dark:border-black bg-gray-900 dark:bg-[#f5f5f7]"></div>
                <h3 className="font-medium text-base text-gray-900 dark:text-[#f5f5f7]">Student Intern</h3>
                <p className="text-sm text-blue-500 dark:text-blue-400 mt-0.5">New Era Signs & Graphics</p>
                <p className="text-xs text-gray-500 dark:text-[#86868b] mt-1 mb-3">Feb 2019 — Apr 2019 • Cavite</p>
                <p className="text-sm leading-relaxed
                  text-gray-600 dark:text-[#a1a1a6]">
                  Managed print production logistics for 50+ projects. Optimized vector rendering processes to reduce material waste by 15%.
                </p>
              </div>
              ...
              <div id="skills" className="mt-16 reveal">
                ...
                <div className="space-y-8">
                  <div>
                    <h4 className="text-[11px] uppercase tracking-wider font-bold mb-4
                      text-gray-500 dark:text-[#6e6e73]">Languages</h4>
                    <div className="flex flex-wrap gap-2.5">
                      {skills.languages.map((skill) => <SkillBadge key={skill} text={skill} />)}
                    </div>
                  </div>

                  <div>
                    <h4 className="text-[11px] uppercase tracking-wider font-bold mb-4
                       text-gray-500 dark:text-[#6e6e73]">Frameworks & Tools</h4>
                    <div className="flex flex-wrap gap-2.5">
                      {skills.frameworks.map((skill) => <SkillBadge key={skill} text={skill} />)}
                    </div>
                  </div>

                  <div>
                    <h4 className="text-[11px] uppercase tracking-wider font-bold mb-4
                       text-gray-500 dark:text-[#6e6e73]">Specialized Areas</h4>
                    <div className="flex flex-wrap gap-2.5">
                      {skills.specialized.map((skill) => <SkillBadge key={skill} text={skill} />)}
                    </div>
                  </div>
                </div>
              </div>
        ...
        {/* Footer */}
        <footer className="mt-20 pt-10 border-t flex flex-col sm:flex-row justify-between items-center gap-6 reveal
          border-gray-200 dark:border-[#1d1d1f]">
          <div className="text-center sm:text-left">
            <p className="text-sm font-medium
              text-gray-900 dark:text-[#f5f5f7]">Joaquin Miguel Dumas</p>
            <p className="text-xs mt-1
              text-gray-500 dark:text-[#6e6e73]">Based in Philippines.</p>
          </div>
          
          <div className="flex gap-6">
            <a href="https://linkedin.com/in/imjoaquindumas" target="_blank" rel="noopener noreferrer" className="transition-colors hover:scale-110
              text-gray-500 hover:text-black
              dark:text-[#86868b] dark:hover:text-white">
              <Linkedin className="w-5 h-5" />
            </a>
            <a href="https://github.com/joaquindumas" target="_blank" rel="noopener noreferrer" className="transition-colors hover:scale-110
              text-gray-500 hover:text-black
              dark:text-[#86868b] dark:hover:text-white">
              <Github className="w-5 h-5" />
            </a>
            <a href="mailto:imjoaquindumas@gmail.com" className="transition-colors hover:scale-110
              text-gray-500 hover:text-black
              dark:text-[#86868b] dark:hover:text-white">
